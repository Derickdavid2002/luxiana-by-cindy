    ...
    <body style="margin:0;padding:0;background:#060606;font-family:Helvetica,Arial,sans-serif">
      <div style="max-width:600px;margin:0 auto;padding:40px 20px">
        ...
        <div style="background:#111111;border:1px solid #1e1e1e;border-radius:16px;padding:32px;text-align:center">
          ...
          <h2 style="color:#f0f0f0;font-size:22px;font-weight:700;margin:0 0 12px">Order Delivered!</h2>
          <p style="color:#7a7a7a;font-size:14px;margin:0 0 24px;line-height:1.7">
            Hi ${customerName}, your order <strong style="color:#E83D8A">#${orderNumber}</strong> has been delivered! We hope you love your Luxiana Beauty products. 💕
          </p>
          <div style="background:#E83D8A11;border:1px solid #E83D8A33;border-radius:10px;padding:16px">
            <p style="color:#E83D8A;font-size:14px;font-weight:600;margin:0">
              Thank you for shopping with Luxiana Beauty! 🛍
            </p>
          </div>
        </div>
